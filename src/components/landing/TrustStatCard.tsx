...
export default function TrustStatCard({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute -right-12 -top-12 h-36 w-36 rounded-full bg-gradient-to-br from-indigo-200/30 to-violet-200/30 opacity-0 blur-3xl transition-opacity duration-500 group-hover:opacity-100"
      />
      ...
      <h3
        id={`${label}-stat`}
        className="relative text-4xl font-extrabold tracking-tight text-slate-900"
      >
        {value}
      </h3>
